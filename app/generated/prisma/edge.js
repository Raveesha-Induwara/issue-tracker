...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\Projects\\issue-tracker\\app\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "E:\\Projects\\issue-tracker\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:root@localhost:5432/issue-tracker?schema=public"
      }
    }
  },
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Issue {\n  id          Int      @id @default(autoincrement())\n  title       String\n  description String\n  status      Status   @default(OPEN)\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n}\n\nenum Status {\n  OPEN\n  IN_PROGRESS\n  CLOSED\n}\n",
  "inlineSchemaHash": "83edd295682c65b1ffaaf7c26dbb31deb41c4bc4a911cb1ea808d225dedcf2a7",
  "copyEngine": true
}
config.dirname = '/'
